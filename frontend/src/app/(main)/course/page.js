        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-0.5">
              {totalItems} course{totalItems !== 1 ? "s" : ""} total · click a row to view batches
            </p>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          {loading ? (
            ...
            <div className="py-16 text-center text-slate-400 text-sm">
              No courses found.{" "}
              <button onClick={openCreate} className="text-indigo-600 font-semibold hover:underline">Create one</button>
            </div>
          ) : (
            <>
                ...
                {courses.map((course, i) => (
                  <div key={course.id}
                    ...
                    <div className="col-span-7 flex items-center gap-2">
                      ...
                      <span className="hidden group-hover:inline-flex text-xs text-indigo-400 font-medium">
                        View batches →
                      </span>
                    </div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 border border-slate-200">
            <h2 className="text-lg font-black text-slate-900 mb-5">{editId ? "Edit Course" : "New Course"}</h2>
            <div className="mb-5">
      ...
      {deleteId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 border border-slate-200">
            ...
            <h2 className="text-lg font-black text-slate-900 text-center mb-1">Delete Course?</h2>
